...
function getPlayerList(query)
{
    ...
    fetch(`http://playerj/back/file/read.php?q=${query}`)
...
{    
    ...
    await fetch(`http://playerj/back/favorite/create.php?q=${query}`)
    .then(res => res.json())
...
async function delFavorite(e)
{
    ...
    document.getElementById("content__animation").innerHTML = "<span class='loader'></span>";
    document.getElementById("content__results").innerHTML = "";
    await fetch(`http://playerj/back/favorite/delete.php?q=${query}`);
    getFavoriteList();
}
...
function getFavoriteList()
{
    ...
    fetch("http://playerj/back/favorite/read.php")
    .then(res => res.json())
    .then(tracks =>
    { 
        if(!tracks.length)
...
function send_file()
{
    ...
    fetch("http://playerj/back/file/create.php",
        {
            method: "POST",
            body: formData
        }
