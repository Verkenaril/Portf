            ...
            <div class="footer__element">
                <div class="footer__group-menu">
                    ...
                    <ul class="footer__menu">
                        ...
                        <a href="#"><li>Персональные данные</li></a>
                        <a href="#"><li>Правила продаж</li></a>
                        <a href="#"><li>Правила пользования сайта</li></a>
                        <a href="#"><li>На информационном ресурсе применяются рекомендательные технологии</li></a>
                        <a href="#"><li>Сервисные центры</li></a>
                    </ul>
                </div>
                ...
                <div class="footer__group-menu">
                    <p>Покупателям</p>
                    <ul class="footer__menu">
                        <a href="#"><li>Как оформить заказ</li></a>
                        <a href="/payments"><li>Способы оплаты</li></a>
                        <a href="/credit"><li>Кредиты</li></a>
                        <a href="#"><li>Доставка</li></a>
                        <a href="#"><li>Статус заказа</li></a>
                        <a href="#"><li>Обмен, возврат, гарантия</li></a>
                        <a href="#"><li>Проверка статуса ремонта</li></a>
                    </ul>
                </div>
            </div>
            ...
            <div class="footer__element">
                <div class="footer__group-menu">
                    ...
                    <ul class="footer__menu">
                        ...
                        <a href="#"><li>Адреса магазинов в г. Москва</li></a>
                    </ul>
                </div>
            </div>    
        </div>
